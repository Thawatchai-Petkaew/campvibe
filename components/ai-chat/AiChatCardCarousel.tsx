 ...
 * snap-scroll strip (~1.5 cards visible, next card peeking). Reuses
 * `AiChatCampCard` (-> `CampgroundCard` compact) UNCHANGED — only the
 * layout container is new (design.md addendum to CAM-272, SUPERSEDES its
