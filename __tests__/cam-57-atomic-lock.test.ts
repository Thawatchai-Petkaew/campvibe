...
// Mock booking-pricing (pure functions, not under test here). CAM-651: the
// route now calls buildBookingPriceArgs (not resolveUnitPrice) directly, so
// that is what must be mocked here.
