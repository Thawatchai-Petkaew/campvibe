...
const jsonSchema = {
  ...
  properties: {
    text: {
      type: 'string',
      description:
        'The camper\'s Thai date phrase, verbatim — relative (for example "พรุ่งนี้", "เสาร์อาทิตย์นี้"), holiday ("วันหยุดยาวหน้า"), an explicit absolute date ("15 ส.ค.", "วันที่ 15 สิงหาคม 2569", "15/8"), or an explicit date RANGE ("19-21 ส.ค.", "19 ถึง 21 สิงหา").',
    },
  },
  required: ['text'],
...
export const resolveDatesTool: ToolDefinition<ResolveDatesArgs, ResolveDatesResult> = {
  name: 'resolveDates',
  description:
    'Deterministically resolve a Thai relative, holiday, absolute, or date-RANGE phrase (e.g. "พรุ่งนี้", "เสาร์อาทิตย์นี้", "วันหยุดยาวหน้า", "15 ส.ค.", "19-21 ส.ค.") into exact ISO date range(s) — a phrase like "19-21 ส.ค." resolves to ONE span (check-in the 19th, checkout the 21st exclusive), never a single day. Call this instead of computing dates yourself; on ok:false, ask the camper to specify the dates instead of guessing.',
  tier: 'guest',
