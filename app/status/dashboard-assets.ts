...
.kc{border-radius:12px;padding:11px;margin-bottom:9px;border:1px solid var(--line);background:var(--glass-2);text-decoration:none;color:inherit;display:block;min-width:0}
