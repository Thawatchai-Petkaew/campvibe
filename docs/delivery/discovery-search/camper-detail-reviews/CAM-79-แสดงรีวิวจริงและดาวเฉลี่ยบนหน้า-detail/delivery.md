...
- PR: [#125](https://github.com/Thawatchai-Petkaew/campvibe/pull/125) — merged into `staging` 2026-06-23
- Merge commit: `c46971afed51f53329598d4fd794610bd5510541`
...
```sh
git revert c46971afed51f53329598d4fd794610bd5510541 --no-edit
git push origin staging
```

This reverts the merge commit on `staging`, restoring the hardcoded "4.8" / "12 รีวิว" display. No DB rollback is needed; no data was written. Vercel auto-deploys on the revert push.
