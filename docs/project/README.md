...
ที่เก็บ **source-of-truth เชิงธุรกิจ/ผลิตภัณฑ์** ของ CampVibe เป็น `.md` ใช้เป็น **context กลาง** ให้ AI delivery team — **อ่านโดย orchestrator + เจ้าของ ก่อนตัดสิน gate** ที่ deterministic check ไม่ครอบ (คุณค่าธุรกิจ, ลำดับความสำคัญ, trade-off)
...
> - **`docs/specs/`** = per-story delivery artifacts (output ของ workflow ต่อ Feature→Epic→Story) — คนละชั้นกับ `docs/project/` (ทิศทาง/ธุรกิจ)
...
3. ถ้าเรื่องนั้น **ไม่อยู่ใน strategy / ขัด principle / มีค่าใช้จ่าย / เป็น judgment เชิงธุรกิจที่เอกสารไม่ฟันธง → orchestrator หยุดถามเจ้าของ** (ไม่เดาแทน)
