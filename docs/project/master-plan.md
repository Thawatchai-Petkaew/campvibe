...
- **Next (P1 — ลำดับ/รายละเอียดเต็ม → [product-plan.md](product-plan.md)):** search/filter ตามจังหวัด · notifications (Telegram/email) · ปรับปรุง SEO หน้า public (`.claude/rules/seo.md`) · ปิด 4 security gap จาก gap-audit
